...
- 单机Linux Host-native Reference Profile，固定Nginx、Certbot、Postfix、PostgreSQL与systemd运行边界，并提供Commit Epoch Layer Timestamp重写、隔离无缓存双构建验证的Linux amd64 Release Bundle。
