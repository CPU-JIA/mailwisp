...
状态：历史研究范围（已完成；当前事实以README、版本锁与已接受ADR为准）
开始日期：2026-07-14
...
研究阶段的文档与ADR均按候选假设处理，不为维护既有Scaffold而固化结论。该原则已经落实；当前架构、版本与支持范围必须以已接受ADR、`deploy/compose/versions.lock`、Lockfile、README和Compatibility文档为准。
